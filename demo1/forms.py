...
class RegistroSintomas(forms.Form):
    ...
    dolor_de_cabeza=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    falta_de_aire=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    diarrea=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    dolor_de_garganta=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    perdida_del_gusto=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    perdida_de_olfato=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
    dolor_en_el_pecho=forms.ChoiceField(widget=forms.Select, choices=tipo_eleccion)
